 ...
 * */
@Deprecated
public abstract class Jackson3XmlRenderFactoryBase implements JsonRenderFactory {
    protected final Jackson3XmlStringSerializer serializer;

    public Jackson3XmlRenderFactoryBase(Jackson3XmlStringSerializer serializer) {
