...
public class NullValueSerializerImpl extends ValueSerializer<Object> {
    ...
    @Override
    public void serialize(Object o, JsonGenerator gen, SerializationContext serializerProvider) throws JacksonException {
        Class<?> type = type0;
        ...
        if (type != null) {
            ...
            if (jsonProps.nullArrayAsEmpty) {
                if (Collection.class.isAssignableFrom(type) || type.isArray()) {
                    gen.writePOJO(Collections.emptyList()); //xml 空数组指定,必须这样写入
